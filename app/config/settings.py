...
GERADOR_URL = os.getenv("GERADOR_URL", "http://localhost:8000")

# Timeout padrão para chamadas HTTP entre servicos (segundos)
HTTP_TIMEOUT = int(os.getenv("HTTP_TIMEOUT", "5"))

# Timeout do fluxo unificado ao chamar o Gerador (POST /diagrama/branch):
# o Gerador orquestra GitHub + IA + mermaid.ink, entao precisa de folga
# (o proprio Gerador usa timeout de 30s para a IA).
DIAGRAMA_TIMEOUT_SEGUNDOS = int(os.getenv("DIAGRAMA_TIMEOUT_SEGUNDOS", "40"))
